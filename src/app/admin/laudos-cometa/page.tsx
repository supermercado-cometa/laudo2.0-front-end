    ...
    <div className="w-full min-h-screen flex flex-col lg:flex-row bg-[#F3F6F9]">
      ...
      <div className="hidden lg:flex lg:w-[35%] bg-gradient-to-br from-[#003B99] to-[#0066FF] p-20 flex-col justify-center relative overflow-hidden sticky top-0 h-screen shadow-2xl">
        ...
        <div className="relative z-10 max-w-sm">
          ...
          <h1 className="text-white text-[42px] lg:font-medium font-black leading-[1.1] uppercase tracking-tight mb-8">
        ...
        <div className="max-w-[850px] w-full mx-auto pb-20">
          <div className="mb-12">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
              <h2 className="text-[#1A1A2E] text-[24px] lg:text-[32px] lg:font-medium font-black tracking-tighter uppercase whitespace-pre-line leading-none">
                {isMineOnly ? "Meus Registros" : "Laudos Gerados"}
              </h2>
              <div className="flex gap-2">
                <Button variant="outline" onClick={() => router.push("/admin/laudo-tecnico")} className="h-12 lg:h-14 rounded-xl text-[10px] lg:text-xs font-black uppercase tracking-widest">Novo Laudo</Button>
                <Button variant="outline" onClick={() => router.push(isMineOnly ? "/admin/laudos-cometa" : "/admin/laudos-cometa?view=meus")} className="h-12 lg:h-14 rounded-xl text-[10px] lg:text-xs font-black uppercase tracking-widest">{isMineOnly ? "Ver Todos" : "Ver Meus"}</Button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[24px] lg:rounded-[32px] p-6 lg:p-8 shadow-sm space-y-6 mb-10 border border-gray-100">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="space-y-2">
                  <Label className="text-[10px] lg:font-medium font-bold uppercase text-gray-400">Chamado</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-[10px] lg:font-medium font-bold uppercase text-gray-400">Tombo</Label>
                ...
                <div className="flex items-end">
                  <Button onClick={fetchLaudos} className="w-full h-12 bg-[#003B99] rounded-xl uppercase tracking-widest lg:font-medium font-bold gap-2 text-[11px]">
                      ...
                      <div className="flex flex-col md:flex-row justify-between gap-6">
                        <div className="space-y-4">
                          <div className="flex items-center gap-3">
                            ...
                            <p className="text-[#1A1A2E] text-[16px] lg:text-[18px] lg:font-medium font-bold uppercase leading-tight">Chamado: {item.numeroChamado}</p>
                          </div>
                        ...
                        <div className="flex flex-col justify-end gap-2 shrink-0">
                          <Button className="h-10 px-8 bg-[#003B99] hover:bg-[#0A2D66] rounded-xl uppercase tracking-wider text-[10px] lg:font-medium font-bold gap-2 shadow-lg shadow-[#003B99]/10">
