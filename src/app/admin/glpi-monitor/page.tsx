      ...
      <div className="flex-1 lg:w-[60%] flex flex-col p-6 lg:p-24 overflow-y-auto">
        <div className="max-w-[800px] w-full mx-auto">
          <div className="flex items-center justify-between mb-12">
            <h2 className="text-[#1A1A2E] text-[32px] font-[800] tracking-tighter">Status do Suporte</h2>
          ...
          {isLoading && !metrics ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100 flex flex-col items-center">
                 ...
                 <span className="text-[48px] font-[800] text-[#1A1A2E] leading-none mb-2">{metrics?.totalTickets || 0}</span>
                 <p className="text-[#6B7280] font-bold uppercase text-[12px] tracking-widest text-center">Tickets Totais</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-[32px] shadow-sm border border-red-50 flex flex-col items-center">
                 ...
                 <span className="text-[48px] font-[800] text-red-600 leading-none mb-2">{metrics?.openTickets || 0}</span>
                 <p className="text-[#6B7280] font-bold uppercase text-[12px] tracking-widest text-center">Aguardando Técnico</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-[32px] shadow-sm border border-blue-50 flex flex-col items-center">
                 ...
                 <span className="text-[48px] font-[800] text-[#0E3D8A] leading-none mb-2">{metrics?.assignedTickets || 0}</span>
                 <p className="text-[#6B7280] font-bold uppercase text-[12px] tracking-widest text-center">Em Atendimento</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-[32px] shadow-sm border border-green-50 flex flex-col items-center">
                 ...
                 <span className="text-[48px] font-[800] text-green-600 leading-none mb-2">{metrics?.closedTickets || 0}</span>
                 <p className="text-[#6B7280] font-bold uppercase text-[12px] tracking-widest text-center">Finalizados Hoje</p>
              </div>
            </div>
          )}
