          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            {filtered.length === 0 && !isLoading && (
              <div className="p-20 text-center bg-gray-50/50 rounded-[40px] border-2 border-dashed border-gray-200">
                <p className="text-gray-400 font-bold uppercase text-[12px] tracking-widest">Nenhum modelo compatível com a busca.</p>
              </div>
            )}
          </div>
        )}
          ...
          <div className="bg-white rounded-[40px] p-8 lg:p-12 max-w-lg w-full shadow-[0_32px_64px_-12px_rgba(0,0,0,0.2)] animate-in zoom-in duration-300">
             ...
             <div className="space-y-8">
                <div className="space-y-3">
                  <label className="text-[11px] font-black uppercase text-gray-400 tracking-wider">Título do Modelo</label>
                  <input 
                    type="text" 
                ...
                <div className="pt-4">
                  ...
                  >
                    <Save className="w-6 h-6" /> {editingId ? 'Salvar Edição' : 'Gerar Novo Modelo'}
                  </button>
                </div>
             </div>
          </div>
