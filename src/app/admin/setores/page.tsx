...
export default function SetoresPage() {
  ...
  const fetchSetores = useCallback(async () => {
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/setores?includeInactive=true`, {
             ...
             <div className="space-y-8">
                 <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 py-2">
                    ...
                    />
                    <label htmlFor="ativo" className="text-gray-700 font-medium cursor-pointer">Setor Ativo</label>
                  </div>
                  <div className="pt-4">
                   <button 
                     onClick={handleSave} 
