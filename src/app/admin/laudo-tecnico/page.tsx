...
export default function InfoFormularioPage() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col lg:flex-row bg-[#F3F6F9]">
      <SubPageHeader title={`Laudo\nTécnico`} icon={ClipboardCheck} backUrl="/admin" />
              ...
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <Input value={dataSistema} disabled className="h-16 rounded-2xl bg-gray-100 border-none lg:sm:font-medium font-bold text-gray-400" />
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 p-8 rounded-[32px] bg-gray-100 border-2 border-dashed border-gray-200 relative group">
                  {imagem ? (
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <span className="text-gray-600 lg:font-medium font-bold text-xs uppercase tracking-widest">{imagem.name}</span>
                      <Button variant="ghost" className="text-red-500 lg:font-medium font-bold uppercase text-[10px]" onClick={() => setImagem(null)}><Trash2 className="w-4 h-4 mr-2" /> Limpar Imagem</Button>
                    </div>
                  ) : (
                    <>
